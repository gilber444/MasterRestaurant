...
@can('CatalogosMH_Index')
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ri-git-repository-fill"></i>
                <div data-i18n="Admin Catálogos MH">Admin Catálogos MH</div>
            </a>
            <ul class="menu-sub">
                {{-- CATALOGOS DTE --}}
                @can('CatalogosDTE_Index')
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
    ...
    @can('AdminInventarios_Index')
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ri-stack-fill"></i>
    ...
    @endcan
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons ri-shopping-cart-2-line"></i></i>
                ...
                @can('Factura_Index')
                    <li class="menu-item {{ Request::is('facturas') ? 'active' : '' }}">
                        <a href="{{ route('facturas') }}" class="menu-link">
                            <div data-i18n="Tipo Facturas">Tipo Facturas</div>
                        </a>
                    </li>
                @endcan
            </ul>
