<x-app-layout>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 align-self-end mt-md-7 mt-lg-4 pt-md-2 pt-lg-0">
            <div class="card">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="card-body">
                            <h4 class="card-title mb-9 text-truncate">
                                {{ __('Bienvenido!') }} <span class="fw-bold">{{ Auth::user()->name }}!</span>🎉
                            </h4>
                        </div>
                    </div>
