<div class="row">
    <div class="col-md-12">
        <div class="card height-equal">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-pill" role="group">
                                            @can('Distritos_Update')
                                                ...
                                                wire:click="Edit({{ $dis->id }})"><i class="ri-edit-box-line"></i>
                                                </button>
                                            @endcan
                                            @can('Distritos_Destroy')
                                                <a href="#" onclick="confirmDestroy({{ $dis->id }})" class="btn rounded-pill btn-icon btn-outline-danger waves-effect btn-sm"><i class="ri-delete-bin-line"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
            ...
            @include('livewire.distritos.forms')
        </div>
    </div>
</div>
