<div class="row">
    <div class="col-md-12">
        <div class="card height-equal">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-pill" role="group">
                                            @can('Municipios_Update')
                                                ...
                                                wire:click="Edit({{ $muni->id }})"><i class="ri-edit-box-line"></i>
                                                </button>
                                            @endcan
                                            @can('Municipios_Destroy')
                                                <a href="#" onclick="confirmDestroy({{ $muni->id }})" class="btn rounded-pill btn-icon btn-outline-danger waves-effect btn-sm"><i class="ri-delete-bin-line"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
            ...
            @include('livewire.municipios.forms')
        </div>
    </div>
</div>
