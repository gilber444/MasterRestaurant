<div class="row">
    <div class="col-md-12">
        <div class="card height-equal">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-responsive-md table-hover">
                        ...
                        <tbody>
                            @forelse ($establecimientos as $data)
                                <tr>
            ...
            @include('livewire.tipo_establecimientos.forms')
        </div>
    </div>
</div>
