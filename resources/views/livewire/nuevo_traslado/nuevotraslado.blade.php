<div class="row" style="display: flex; flex-direction: column;">
    ...
    <div class="col-xxl">
        <div class="card mb-6">
            <div style="display: flex; justify-content: space-between;align-items: center; margin-bottom: -3rem;">
                ...
                <div>
                    <button style="margin-left: 28rem;" wire:click="resetProcess" type="submit" class="btn btn-danger waves-effect waves-light">
                        <i style="margin-right: 0.3rem;" class="ri-close-large-line"></i>
                        Cancelar
                    </button>
                    <button type="submit" wire:click="Store()" class="btn btn-primary me-4 waves-effect waves-light mr-2">
                    ...
                    <table class="table table-responsive-md table-hover">
                        ...
                        <tbody id="selectedProductsBody">
                            ...
                            <tr>
                                ...
                                <td class="text-center">${{number_format($i->costo, 2)}}</td>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            cargaDatos();
            document.querySelector('#formTraslado').addEventListener('keypress', function(event) {
                if (event.keyCode === 13) {
