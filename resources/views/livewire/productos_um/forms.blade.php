            ...
            <div class="modal-body">
                <div class="tab-content" style="border: 1px solid #e6e6e6; border-radius: 1rem; margin-bottom: 0rem;">
                    <div class="tab-pane fade active show" id="form-tabs-personal" role="tabpanel">
                        <form>
                            <h6 class="mb-7">1. Detalles - UM</h6>
                            <div class="row mt-2">
                                ...
                                <div class="input-group input-group-merge mb-5 w-100">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" wire:model.lazy="nombre" class="form-control" placeholder="Unidad">
                                        <label for="nombre">Nombre UM</label>
                                ...
                                <div class="input-group input-group-merge mb-5 w-100">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" wire:model.lazy="simbolo" class="form-control" placeholder="UM">
                                        <label for="simbolo">Simbolo UM</label>
