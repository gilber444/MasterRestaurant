<div class="row">
    <div class="col-md-12">
        <div class="card height-equal">
            ...
            @include('livewire.documento_contingencias.forms')
        </div>
    </div>
</div>
