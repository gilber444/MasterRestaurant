<div class="card mb-0">
    <div class="card-body card-separator">
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
            <h5 class="m-0 me-2">Nueva Compra</h5>
            <div class="d-flex">
                ...
                <button type="button" class="btn rounded-pill btn-label-primary waves-effect"
                    wire:click.prevent="Store()"><i class="ri-save-line"></i> Procesar Compra
                </button>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-4">
                    <div class="form-floating form-floating-outline mb-6">
                        <select wire:model='condicionPago' class="form-select" aria-label="Elegir forma de pago">
