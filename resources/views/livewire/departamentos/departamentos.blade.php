<div class="row">
    <div class="col-md-12">
        <div class="card height-equal">
                        ...
                        <tbody>
                            @forelse ($departamentos as $depto)
                                <tr>
                                    ...
                                    <td class="text-center"> {{ $depto->departamento }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-pill" role="group">
                                            @can('Departamentos_Update')
                                                ...
                                                wire:click="Edit({{ $depto->id }})"><i class="ri-edit-box-line"></i>
                                                </button>
                                            @endcan
                                            @can('Departamentos_Destroy')
                                                <a href="#" onclick="confirmDestroy({{ $depto->id }})" class="btn rounded-pill btn-icon btn-outline-danger waves-effect btn-sm"><i class="ri-delete-bin-line"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
            ...
            @include('livewire.departamentos.forms')
        </div>
    </div>
</div>
