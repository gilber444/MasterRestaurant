<div class="card mb-0">
    <div class="card-body card-separator">
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4">
            <h5 class="m-0 me-2">Nuevo Ajuste</h5>
            <div class="d-flex">
                ...
                <button type="button" class="btn rounded-pill btn-label-primary waves-effect" wire:click.prevent="Store()"><i
                        class="ri-save-line"></i> Procesar Ajuste
                </button>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    <div class="form-floating form-floating-outline mb-6">
                        <select wire:model='sucursal' class="form-select" aria-label="Elegir Sucursal">
                ...
                <div class="col-sm-12 col-md-3">
                    <div class="form-floating form-floating-outline mb-6">
                        <select wire:model='tipo' class="form-select" aria-label="Elegir Tipo Ajuste">
                        ...
                        <select id="select2ActiProducto"
                            ...
                            @forelse ($productos as $producto)
                                <option value="{{ $producto->id }}">
                                    ...
                                    {{ $producto->RunidadMedida->nombre }} - {{ $producto->csiva }}
                                </option>
                            @empty
                            ...
                            <tbody id="selectedProductsBody">
                                @forelse ($items as $i)
                                    <tr>
                                        ...
                                        <td class="text-end">${{ number_format($i->costo, 2) }}</td>
