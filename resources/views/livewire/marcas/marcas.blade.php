                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-pill" role="group">
                                            @can('Marcas_Update')
                                                ...
                                                wire:click="Edit({{ $m->id }})"><i class="ri-edit-box-line"></i>
                                                </button>
                                            @endcan
                                            @can('Marcas_Destroy')
                                                <a href="#" onclick="confirmDestroy({{ $m->id }})" class="btn rounded-pill btn-icon btn-outline-danger waves-effect btn-sm"><i class="ri-delete-bin-line"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
