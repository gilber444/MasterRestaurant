            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-responsive-md table-hover">
                        ...
                        <tbody>
                            @forelse ($ambientes as $am)
                                <tr>
                                    <td class="text-center">{{ $am->codigo }}</td>
                                    <td class="text-center"> {{ $am->valor }}</td>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-pill" role="group">
                                            @can('Ambientes_Update')
                                                <button class="btn rounded-pill btn-icon btn-outline-warning waves-effect btn-sm"
                                                wire:click="Edit({{ $am->id }})"><i class="ri-edit-box-line"></i>
                                                </button>
                                            @endcan
                                            @can('Ambientes_Destroy')
                                                <a href="#" onclick="confirmDestroy({{ $am->id }})" class="btn rounded-pill btn-icon btn-outline-danger waves-effect btn-sm"><i class="ri-delete-bin-line"></i></a>
                                            @endcan
                                        </div>
                                    </td>
                                </tr>
