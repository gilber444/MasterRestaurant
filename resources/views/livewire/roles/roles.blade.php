        ...
        <div class="card card-absolute">
            ...
            <div class="card-body">
                ...
                <div class="input-group">
                    ...
                    @canany(['Roles_Create', 'Roles_Update'])
                        @if ($roleId == null && Gate::allows('Roles_Create'))
                            <span wire:click="createRole" class="input-group-text" style="cursor: pointer"
                                {{ $roleName === null ? 'disabled' : '' }}>
                                <i class="ri-save-line"></i>
                            </span>
                        @elseif($roleId != null && Gate::allows('Roles_Update'))
                            <span wire:click="updateRole" class="input-group-text" style="cursor: pointer"
                                {{ $roleName === null ? 'disabled' : '' }}>
                                <i class="ri-save-line"></i>
                            </span>
                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group btn-group-pill" role="group" aria-label="Basic example">
                                            @can('Roles_Update')
                                                <button
                                                    class="btn rounded-pill btn-icon btn-outline-warning waves-effect btn-sm"
                                            ...
                                            @can('Roles_Destroy')
                                                <button
                                                    class="btn rounded-pill btn-icon btn-outline-danger waves-effect btn-sm"
                    ...
                    <div class="col-sm-12 col-md-8">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control @error('permissionName') border-danger @enderror"
                                ...
                                id="permissionName">
                            @canany(['Permisos_Create', 'Permisos_Update'])
                                @if ($permissionId == null && Gate::allows('Permisos_Create'))
                                    <span wire:click="createPermission" class="input-group-text" style="cursor: pointer"
                                        {{ $permissionName == null ? 'disabled' : '' }}>
                                        <i class="ri-save-line"></i>
                                    </span>
                                @elseif($permissionId != null && Gate::allows('Permisos_Update'))
                                    <span wire:click="updatePermission" class="input-group-text" style="cursor: pointer"
                                        {{ $permissionName == null ? 'disabled' : '' }}>
                                        <i class="ri-save-line"></i>
                                    </span>
                                @endif
