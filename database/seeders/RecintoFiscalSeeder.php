...
class RecintoFiscalSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $recinto = [
            ...
            ['codigo' => '37', 'valor' => 'Z.F. Parque Industrial Sam-Li', 'status' => 'Desactivado'],
            ['codigo' => '38', 'valor' => 'Z.F. San José', 'status' => 'Desactivado'],
            ['codigo' => '39', 'valor' => 'Z.F. Las Mercedes', 'status' => 'Desactivado'],
            ['codigo' => '71', 'valor' => 'Almacenes De Desarrollo (Aldesa)', 'status' => 'Desactivado'],
            ['codigo' => '72', 'valor' => 'Almac. Gral. Dep. Occidente (Agdosa)', 'status' => 'Desactivado'],
            ['codigo' => '73', 'valor' => 'Bodega General De Depósito (Bodesa)', 'status' => 'Desactivado'],
            ['codigo' => '76', 'valor' => 'DHL', 'status' => 'Desactivado'],
            ['codigo' => '77', 'valor' => 'Transauto (Santa Elena)', 'status' => 'Desactivado'],
            ['codigo' => '80', 'valor' => 'Almacenadora Nejapa, S.a. de C.V.', 'status' => 'Desactivado'],
            ['codigo' => '81', 'valor' => 'Almacenadora Almaconsa S.A. De C.V.', 'status' => 'Desactivado'],
            ['codigo' => '83', 'valor' => 'Alm.Gral. Depósito Occidente (Apopa)', 'status' => 'Desactivado'],
